...
public class DateUtil extends Object {
    ...
    public static Date getDateTimeFromDate(Date date,String format) throws ParseException{
    	SimpleDateFormat sdf = new SimpleDateFormat(format);
...
//    }
    ...
    public static String getDateTimeFromString(String d, String format,String rtnFormat){
         ...
         try { System.out.println(sdf.parse(d));
...
//    	System.out.println(getMinuteBefore(15));
//    	System.out.println(new Date());
//    	System.out.println(DateUtil.getDateTimeFromString("2012-04-16","yyyy-MM-dd","yyyyMMdd"));
//    	System.out.println(DateUtil.string2Date("2017-02-17", "yyyyMMdd"));
    	Date date = DateUtil.getDateFromString("2012-04-16");
    	System.out.println(DateUtil.getDateTimeFromDate(date, "yyyy-MM-dd HH:mm:ss"));
