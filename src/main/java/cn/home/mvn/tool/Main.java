...
/**
 * <p>Title: Main</p>
 * <p>Description: 删除JAR</p>
 * <p>Company: ChinaBank</p>
 * @ClassName: Main
 * @author qinhaihong
 * @date 2013年9月3日 下午3:52:03
 * @version 1.0.0
 */
@SuppressWarnings("restriction")
public class Main {
	private static final Log _log = LogFactory.getLog(Main.class);
	private static PropertyHelper propHelper = new PropertyHelper("m2e");
	...
	private static void installJarToMaven(File file) {
		...
		_log.info("Jar ["+jarName+"] will be installed with the groupId="+groupId+" ,"+"artifactId="+artifactId+" , version="+version+".");
